...
data.gen.mon.char <- apply_labels(data.gen.mon.char,
                                  WorldwideGross = "Worldwide Gross", OverseasGross = "Overseas Gross", WeekendGross = "Weekend Gross", DomesticGross = "Domestic Gross")
